...
public final class InfoBottomSheetBinding implements ViewBinding {
  ...
  @NonNull
  public final ToggleButton switchToCloudButton;
  ...
  private InfoBottomSheetBinding(@NonNull NestedScrollView rootView,
      ...
      @NonNull Spinner spinnerModel, @NonNull ImageView statsIcon,
      @NonNull LinearLayout statsSection, @NonNull ToggleButton switchToCloudButton,
      @NonNull TextView textViewBatteryConsumption, @NonNull TextView textViewBatteryLevel,
      @NonNull TextView textViewCpuUsage, @NonNull TextView textViewSelectedModel,
    ...
    this.switchToCloudButton = switchToCloudButton;
  ...
  public static InfoBottomSheetBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.switchToCloudButton;
      ToggleButton switchToCloudButton = ViewBindings.findChildViewById(rootView, id);
      if (switchToCloudButton == null) {
        break missingId;
      }
      ...
      return new InfoBottomSheetBinding((NestedScrollView) rootView, batteryConsumptionChart,
          ...
          spinnerDelegate, spinnerModel, statsIcon, statsSection, switchToCloudButton,
          textViewBatteryConsumption, textViewBatteryLevel, textViewCpuUsage, textViewSelectedModel,
